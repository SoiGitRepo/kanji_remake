...
final speechSpeedProvider = StateProvider<SpeechSpeed>((ref) => SpeechSpeed.Medium);

final reviewQuestionOrderProvider =
    StateProvider<ReviewQuestionOrder>((ref) => ReviewQuestionOrder.EnglisnFirst);
